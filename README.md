 ...
 * Тест добавления контакта (юнит-тест): __Проверяет, правильно ли приложение добавляет новый контакт в записную книжку._   
 * Тест редактирования контакта (юнит-тест): __Проверяет, правильно ли приложение обновляет существующий контакт в записной книжке._  
